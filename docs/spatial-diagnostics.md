...
Covering diagnostics: requested=120, returned=96, effective=32, estimated=245760, maxFallback=true, enumerationFallback=false
...
* **Covering diagnostics** – the Morton covering stats: how many ranges were requested, returned, and ultimately scanned (`effective`), an estimated cell count, and whether the encoder hit either the max-cell fallback or the coarse enumeration fallback.
...
Covering diagnostics: requested=1, returned=1, effective=1, estimated=32768, maxFallback=false, enumerationFallback=false
