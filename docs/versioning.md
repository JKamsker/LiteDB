...
./eng/gitversion.ps1            # show version for HEAD
./eng/gitversion.ps1 dev~3      # inspect an arbitrary commit
./eng/gitversion.ps1 -Json      # emit raw JSON
```

```bash
# Bash (macOS, Linux, Git Bash on Windows)
./eng/gitversion.sh             # show version for HEAD
./eng/gitversion.sh dev~3       # inspect an arbitrary commit
./eng/gitversion.sh --json      # emit raw JSON
```
