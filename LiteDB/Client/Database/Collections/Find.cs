...
namespace LiteDB
{
    public partial class LiteCollection<T>
    {
        ...
        public T FindById(BsonValue id)
        {
            ...
            var filter = BsonExpression.Create("_id = @0", _expressions, id);
        ...
        {
            var expression = BsonExpression.Create(predicate, parameters, _expressions);
        ...
        {
            var expression = BsonExpression.Create(predicate, _expressions, args);
