...
namespace LiteDB
{
    public partial class LiteCollection<T>
    {
        ...
        public int UpdateMany(Expression<Func<T, T>> extend, Expression<Func<T, bool>> predicate)
        {
            ...
            var ext = _mapper.GetExpression(extend, _expressions, _database, _linqResolvers);
            var pred = _mapper.GetExpression(predicate, _expressions, _database, _linqResolvers);
