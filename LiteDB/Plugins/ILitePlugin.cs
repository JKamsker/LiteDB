...
namespace LiteDB.Plugins
{
    ...
    public interface ILitePluginContext
    {
        ...
        /// <summary>
        /// Gets the registry for plugin index metadata serializers.
        /// </summary>
        Indexing.IPluginIndexMetadataRegistry IndexMetadata { get; }

        /// <summary>
        /// Gets the registry for plugin SQL functions.
        /// </summary>
        Query.ISqlFunctionRegistry SqlFunctions { get; }

        /// <summary>
        /// Gets the registry for plugin query operators.
        /// </summary>
        Query.IQueryOperatorRegistry QueryOperators { get; }

        /// <summary>
        /// Gets the registry for plugin query cost models.
        /// </summary>
        Query.IQueryCostModelRegistry QueryCostModels { get; }

        /// <summary>
        /// Gets the plugin diagnostic policy.
        /// </summary>
