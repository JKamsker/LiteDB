...
namespace LiteDB.Plugins
{
    ...
    public interface IExpressionRegistry
    {
        void RegisterOperator(
            ...
            int precedence = ExpressionPrecedence.Comparison,
            string source = null);
