...
namespace LiteDB.Plugins
{
    internal sealed class DefaultPluginContext : ILitePluginContext
    {
        ...
        public Indexing.IPluginIndexMetadataRegistry IndexMetadata { get; }

        public Query.ISqlFunctionRegistry SqlFunctions { get; }

        public Query.IQueryOperatorRegistry QueryOperators { get; }

        public Query.IQueryCostModelRegistry QueryCostModels { get; }

        public IPluginDiagnosticPolicy DiagnosticPolicy { get; }
