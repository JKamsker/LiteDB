...
- 001-vector-plugin-migration: Added [e.g., Python 3.11, Swift 5.9, Rust 1.75 or NEEDS CLARIFICATION] + [e.g., FastAPI, UIKit, LLVM or NEEDS CLARIFICATION]

- 001-spatial-plugin-migration: Added C# targeting .NET Standard 2.0 and .NET 8.0 + LiteDB core, LiteDB plugin framework, LiteDB.Spatial.* packages, xUnit + FluentAssertions
